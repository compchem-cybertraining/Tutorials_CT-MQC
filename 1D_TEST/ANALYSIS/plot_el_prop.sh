...
p 'BO_population.dat' u (\$1*0.024):2 w l ls 1 t 'ground state', \
  ...
  'BO_population.dat' u (\$1*0.024):4 every 10 w lp ls 3 t '', \
  'BO_population.dat' u (\$1*0.024):5 every 10 w lp ls 4 t '', \
  ...
  '$filecoh' u (\$1*0.024):2 axis x1y2 w l ls 8 t 'exact coherence'
