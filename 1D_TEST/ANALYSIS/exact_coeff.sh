...
p '$datafile' u 1:2 every 10 w p pt 4 ps 0.8  lc rgb "red" t 'FOR STATE 1', \
  '$datafile' u 1:3 every 10 w p pt 6 ps 0.8 lc rgb "blue" t 'FOR STATE 2', \
  '$datafile' u 1:4 every 10 w p pt 26 ps 0.4 lc rgb "black" t 'COHERENCE', \
